...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BuShInKiTEAM/Files_BuShInKi/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁┇اهلا بك في متجر ملفات بويكا\n🔰┇ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘┇ علامة تعني { ✓ } ملف مفعل\n🔘┇علامة تعني { ✘ } ملف معطل\n🔖┇قناة سورس بويكا ↓\n".."📮┇[اضغط هنا لدخول](t.me/BuShInKi) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BuShInKiTEAM/Files_BuShInKi/master/File_Bot/"..file)
if res == 200 then
